        ...
        skin = """
        	<screen name="nvKeyboardSetup" position="center,center" size="1080,300" backgroundColor="#16000000" title="New Virtual Keyboard Settings  V %s">
            	...
            	<ePixmap position="30,230" size="38,38" pixmap="~/images/key_red.png" zPosition="3" transparent="1" alphaTest="blend" />
             	<eLabel position="78,230" zPosition="4" size="300,38" verticalAlignment="center" font="Regular;30" transparent="1" foregroundColor="#ffffff" backgroundColor="#41000000" text="Cancel" />

            	<ePixmap position="330,230" size="38,38" pixmap="~/images/key_green.png" zPosition="3" transparent="1" alphaTest="blend" />
            	<eLabel position="378,230" zPosition="4" size="300,38" verticalAlignment="center" font="Regular;30" transparent="1" foregroundColor="#ffffff" backgroundColor="#41000000" text="Save" />

            	<ePixmap position="630,230" size="38,38" pixmap="~/images/key_yellow.png" zPosition="3" transparent="1" alphaTest="blend" />
            	<eLabel position="678,230" zPosition="4" size="420,38" verticalAlignment="center" font="Regular;30" transparent="1" foregroundColor="#ffffff" backgroundColor="#41000000" text="Virtual keyboard" />
        	</screen>""" % VER
    else:
        skin = """
        	<screen name="nvKeyboardSetup" position="center,center" size="720,190" backgroundColor="#16000000" title="New Virtual Keyboard Settings  V %s">
            	...
            	<eLabel position="52,150" zPosition="4" size="200,25" verticalAlignment="center" font="Regular;20" transparent="1" foregroundColor="#ffffff" backgroundColor="#41000000" text="Cancel" />

            	<ePixmap position="220,150" size="25,25" pixmap="~/images/key_green_sd.png" zPosition="3" transparent="1" alphaTest="blend" />
            	<eLabel position="252,150" zPosition="4" size="200,25" verticalAlignment="center" font="Regular;20" transparent="1" foregroundColor="#ffffff" backgroundColor="#41000000" text="Save" />

            	<ePixmap position="420,150" size="25,25" pixmap="~/images/key_yellow_sd.png" zPosition="3" transparent="1" alphaTest="blend" />
            	<eLabel position="452,150" zPosition="4" size="280,25" verticalAlignment="center" font="Regular;20" transparent="1" foregroundColor="#ffffff" backgroundColor="#41000000" text="Virtual keyboard" />
        	</screen>""" % VER
